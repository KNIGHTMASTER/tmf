package id.co.telkomsigma.tms.service.scaffolding.impl;

import id.co.telkomsigma.tms.dao.exception.DAOException;
import id.co.telkomsigma.tms.dao.scaffolding.IScaffoldingDAO;
import id.co.telkomsigma.tms.data.constant.TmsConstant;
import id.co.telkomsigma.tms.data.model.base.AAuditTrail;
import id.co.telkomsigma.tms.service.exception.ServiceException;
import id.co.telkomsigma.tms.service.scaffolding.IScaffoldingService;
import id.co.telkomsigma.tms.service.scaffolding.IServiceInitializer;
import id.co.telkomsigma.tms.util.common.random.RandomStringGenerator;
