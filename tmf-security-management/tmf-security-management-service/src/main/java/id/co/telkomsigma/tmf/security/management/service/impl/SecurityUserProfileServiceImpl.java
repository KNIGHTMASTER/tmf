package id.co.telkomsigma.tmf.security.management.service.impl;
...
import id.co.telkomsigma.tmf.data.dto.response.*;
...
import id.co.telkomsigma.tmf.security.management.service.ISecurityUserAddressService;
import id.co.telkomsigma.tmf.security.management.service.ISecurityUserContactService;
import id.co.telkomsigma.tmf.security.management.service.ISecurityUserProfileService;
import id.co.telkomsigma.tmf.security.management.service.ISecurityUserVerificationService;
import id.co.telkomsigma.tmf.service.*;
            ...
            try{
            	...
            	if (sup != null){
                    ...
                    if (p_RequestUpdateProfileDTO.getBirthDate() != null){
                    	try {
                            sup.setBirthDate(new SimpleDateFormat(TMFConstant.Common.DATE_FORMAT).parse(p_RequestUpdateProfileDTO.getBirthDate()));
        ...
        try {                        
            ...
            if (profile != null){
            	...
            	if (profile.getBirthDate() != null){
            		profileResponseDTO.setBirthdate(new SimpleDateFormat(TMFConstant.Common.DATE_FORMAT).format(profile.getBirthDate()));
            	}                
