...
public abstract class AScaffoldingEndPoint<DATA> implements IScaffoldingEndPoint<DATA>, IEndPointInitializer {
	...
	@Override
	public ResponseData approveAll() throws EndPointException {
	...
	@Override
	public ResponseData approveSingleData(@RequestBody RequestID p_RequestID) throws EndPointException {
		try {
	...
	@Override
	public ResponseData cancelAll()throws EndPointException {
		try {
	...
	@Override
	public ResponseData cancelSingleData(@RequestBody RequestID p_RequestID) throws EndPointException {
		try {
